...
public class ConsoleWordleGame {
    public static void main(String[] args) {
        // You may need to provide the path to the dictionary file containing 5-letter words.
        ...
        while (true) {
            ...
            while (!wordleController.isGameOver() && !wordleController.isGameWon()) {
                System.out.printf("You have %d attempts remaining. Enter your guess: ", wordleController.getAttemptsRemaining());
